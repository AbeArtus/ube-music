from Shared import Dialog, Menu, Option, Position

def install(cls):
    cls.open_shop_menu = open_shop_menu
    cls.open_item_menu = open_item_menu
    cls.open_unit_menu = open_unit_menu
    cls.open_stats = open_stats
